...
function th_themehelper_menu() {
 ...
 add_menu_page('theme helper admin menu', 'Theme Helper', 'administrator', __FILE__, 'th_themehelper_settings_page',plugins_url('/images/themehelper-icon.png', __FILE__), 7.5);
